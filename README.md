...
> **⚠️ Notice:** YouTube, Twitter (without Media) and Instagram downloads are temporarily disable due to recent API changes. Other platforms (SoundCloud, Twitter, TikTok) work normally. We are working on a fix.
## ✨ Features
