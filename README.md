...
[فارسی](https://github.com/BakerStreetBoys/socialmedia-downloader/blob/main/README.fa.md)    English
...
> **⚠️ Notice:** YouTube, Instagram, and Twitter profile/thread downloads are temporarily disabled due to recent API changes. Single tweets with media, SoundCloud, and TikTok work normally. We are working on a fix.
## ✨ Features
